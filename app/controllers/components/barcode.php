...
class AxbarcodeComponent extends Component	{
	...
	public var $barcode_printer_cmd=array('text'=>'A', 'barcode'=>'B');
	
	public var $barcode_types=array(
	...
	public var $barcodeString=array(
		...
		'p4'=>array('name'=>'Tipo de Codigo', 'value'=>$barcode_types['128']['code'], 'validValues'=>$barcode_types),
		'p5'=>array('name'=>'Ancho (delgados)', 'value'=>$barcode_types['128']['minWidth'] ),
		'p6'=>array('name'=>'Ancho (anchos)', 'value'=>0, 'minValue'=>2, 'maxValue'=>30),
		'p7'=>array('name'=>'Alto', 'value'=>20),
		'p8'=>array('name'=>'Imprimir codigo como texto', 'value'=>'B', 'validValues'=>array('B'=>'Si','N'=>'No')),
	...
	function ean13_checkdigit($message) {
		$checksum = 0;
