...
/*
    var $fieldFormatting    = array(
                    ...
                    "timestamp"=>array("DATE_FORMAT(%1\$s, '%%d-%%m-%%Y')", "%2\$s")
                    );
*/
/*
    var $fieldFormatting    = array(
                    "string"=>array("%1\$s LIKE", "%%%2\$s%%"),
                    "text"=>array("%1\$s LIKE", "%%%2\$s%%"),
                    "date"=>array("%1\$s", "CAST('%2\$s' AS DATE)"),
                    "datetime"=>array("CAST(%1\$s AS DATE)", "CAST('%2\$s' AS DATE)"),
                    "timestamp"=>array("CAST(%1\$s AS DATE)", "CAST('%2\$s' AS DATE)"),
                    );
*/
