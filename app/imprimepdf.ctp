...
$tcpdf->SetSubject('COMPROBANTE FISCAL CFDI INGRESO. FACTURA '.$data['Master']['farefer'].' ( uuid: '.$data['Master']['uuid'].' )');
...
<table cellpadding="0" cellspacing="0" border="0" width="100%">
	...
	<tr><td>
		...
		Colonia Granjas Mexico. Delegación Iztacalco.<br/>
...
$head=	'<table cellspacing="4" cellpadding="0" border="0" width="100%"><tr><td width="50%">'.
		...
		$head_right.
		'</td></tr></table>';
$tcpdf->writeHTML($head, true, 0, true, 0);
$tcpdf->Ln();
...
$body='
	<table style="font-size: 7pt; width: 100%; border: 1px solid #000000;" border="1">
		<tr style="text-align:center; background-color: #D0D0D0; font-weight: bold;">
			...
			<td style="width: 4in;">Descripcion</td>
...
';
			...
			foreach($data['Details'] as $item):
				...
				<td style="width: 0.5in;">'.htmlentities(utf8_encode($item['Articulo']['arunidad'])).'&nbsp;</td>
				<td style="width: 4.0in;">'.htmlentities(utf8_encode($item['Articulo']['ardescrip'])).'&nbsp;</td>
...
$tcpdf->writeHTML($body, true, 0, true, 0);
$tcpdf->Ln();

$totales='
	<table style="width: 100%; border: 1px solid #000;" border="1" cellspacing="0" cellpadding="0">
			<tr>
				<td style="text-align: right; width: 0.5in;">&nbsp;</td>
				<td style="width: 0.5in;">&nbsp;</td>
				<td style="width: 4in;">&nbsp;</td>
				<td style="text-align: right; width: 0.75in;">Suma: </td>
			...
			<tr>
				...
				<td style="width: 0.5in;">&nbsp;</td>
				<td style="width: 4in;">&nbsp;</td>
				<td style="text-align: right; width: 0.75in;">DESCTO: '. $data['Master']['fadesc1'].'</td>
			...
			<tr>
				...
				<td style="width: 0.5in;"> &nbsp;</td>
				<td style="width: 4in;">&nbsp;</td>
				<td style="text-align: right; width: 0.75in;">SUBTOTAL:</td>
			...
			<tr>
				...
				<td style="width: 0.5in;">&nbsp;</td>
				<td style="width: 4in;">&nbsp;</td>
				<td style="text-align: right; width: 0.75in;">IVA '.$data['Master']['faimpu'].'%:</td>
			...
			<tr>
				...
				<td>&nbsp;</td>
				<td style="width: 4in;">&nbsp;</td>
				<td style="text-align: right; width: 0.75in;">TOTAL:</td>
				<td style="text-align: right; width: 1.25in;"><b>'.number_format($data['Master']['factura__fatotal'],4).'</b></td>
			</tr>
	</table>';

$tcpdf->writeHTML($totales, true, 0, true, 0);
$tcpdf->Ln();

$pago='
	<div style="border: 1px solid #000; width: 100%;">
		<font size="-1"><b> Prendas totales: </b>'.(int)$ptotal.'</font>&nbsp;&nbsp;
		<font size="-1"><b> Forma de pago: </b>TRANSFERENCIA</font>&nbsp;&nbsp;
		<font size="-1"><b> Condiciones de pago: </b>'.(int)$data['Master']['faplazo'].' días</font>&nbsp;&nbsp;
		<font size="-1"><b> Metodo de pago: </b>EN UNA SOLA EXHIBICIÓN</font>&nbsp;&nbsp;
		<font size="-1"><b> Num. cuenta pago: </b>NO IDENTIFICADA</font>
	</div>
';
$tcpdf->writeHTML($pago, true, 0, true, 0);
$tcpdf->Ln();
...
//$tcpdf->writeHTML($avisos, true, 0, true, 0);
$tcpdf->Ln();
...
//$tcpdf->writeHTML($cadena, true, 0, true, 0);
$tcpdf->Ln();
...
$tcpdf->writeHTML($sello, true, 0, true, 0);
//$tcpdf->Ln();
...
//$tcpdf->writeHTML($sellosat, true, 0, true, 0);
$tcpdf->Ln();
...
$timbre='
	<table style="width: 100%; border: 1px solid #000000; padding: 0px;" border="1" cellpadding="2">
		...
		<td style="width: 30%;">
			<img style="width: 1.15in; height: 1.15in;" src="'.(APP.DS.'files'.DS.'comprobantesdigitales'.DS.'JME910405B83-'.$data['Master']['farefer'].'.png').'" border="0" />
		</td>
		<td style="width: 70%;">
			<p>
...
$tcpdf->writeHTML($timbre, true, 0, true, 0);
$tcpdf->Ln();
	...
	<tr>
		<td colspan="2">
			...
			<div id="divMarcas" style="font-size: 6pt;  border-top: 1px solid #000; font-weight: bold; width: 100%; text-align: left;">
				Las marcas registradas: HARD, WILD, BIG JOHN, OIL, STATION, OLE JEANS, SIENTE EL AZUL, OGGI STAR, OGGI MAX, OG JEANS, OGGI JEANS, BLURING, OGGI RED, OGGI BLUE. Son propiedad de Junior de Mexico, S.A. de C.V.
			</div>
...
<table cellpadding="0" cellspacing="0" border="0" width="100%" style="background: transparent;">
	...
	<tr><td><b>Domicilio:</b></td></tr>
	<tr><td>'.
			'Calle: '.$data['Clientesdireccion']['clcalle'].'.<br />'.
			'Número Exterior: '.$data['Clientesdireccion']['clnumext'].'.&nbsp;&nbsp;&nbsp;&nbsp;'.'Número Interior: '.$data['Clientesdireccion']['clnumint'].'.<br />'.
			'Colonia: '.$data['Clientesdireccion']['clcolonia'].'. '.
			'Delegación: '.$data['Clientesdireccion']['cldelegacion'].'.<br />'.
			'Ciudad: '.$data['Clientesdireccion']['clciu'].'.&nbsp;&nbsp;&nbsp;&nbsp;'.' Estado: '.$data['Clientesdireccion']['cledo'].'.<br />'.
			'País: '.$data['Clientesdireccion']['clpais'].'.&nbsp;&nbsp;&nbsp;&nbsp;'.' C.P.: '.$data['Clientesdireccion']['clcp'].'.<br />'.
			'
	</td></tr>
	<tr><td>&nbsp;</td></tr>
	<tr><td><b>Enviar a:</b><br/ >'.$data['Cliente']['clenviara'].'.</td></tr>
	<tr><td><b>Pedido:</b> '.$data['Master']['fapedido'].'.</td></tr>
