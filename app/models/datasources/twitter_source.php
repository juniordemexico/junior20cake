...
class TwitterSource extends DataSource
{
	...
	var $consumer_key = "";
	var $consumer_secret = "";
	var $access_token = "135223442-Htm1FYjPLa1bWrXsvkrYLM6u0xHURqBHOtXyPEUy";
	var $access_token_secret = "S4ZHVe9Wk1VlLyDpRxvqmsWWOYNsKwEdlsndIBI";
	...
	function __construct($config) {
		...
		$this->twitterAuth=new twitteroauth($this->consumer_key,$this->consumer_secret,$this->access_token,$this->access_token_secret);
	}
	...
	function status_public_timeline($params=array()) {
		...
		return $this->__process($this->twitterAuth->get('statuses/home_timeline', $params));
	}
	...
	function status_friends_timeline($id=false, $params = array()) {
		...
		return $this->__process($this->twitterAuth->get('statuses/friends_timeline', $params));
	}
