	...
	<table id="datagrid" class="table table-bordered table-striped table-condensed table-hover">
		<thead>
			<tr class="row-filter">
				...
				<th class="st"><?php echo $form->text('Explosion.modified',array('label' => false, 'type' => 'search', 'placeholder'=>'Fecha Modificado', 'class' => 'search-query'));?></th>
				<th class="id">
			...
			<tr class="row-labels">
				...
				<th class="st"><?php echo $this->Paginator->sort('Modificado','Explosion.modified'); ?></th>
		...
		<?php foreach ($articulos as $articulo): ?>
			<tr id="<?php echo $articulo['Articulo']['id'];?>" class="t-row">
				...
				<td class="st"><?php echo $articulo['0']['modified']; ?></td>
