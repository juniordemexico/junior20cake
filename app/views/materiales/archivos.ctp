...
<!--Carousel Begin -->
<?php
$imgResults = $this->Upload->listing ('img/Material', $this->data['Articulo']['id']);
...
<div id="tabs-1" class="tab-pane">
	...
	<?php echo $this->Upload->edit('ico/Material', $this->data['Articulo']['id']); //$this->Form->fields['Articulo.id'] ?>
</div>

<div id="tabs-2" class="tab-pane">
	<label class="label">Imagenes y Fotografias <i>( jpg, png )</i></label>
	<?php echo $this->Upload->edit('img/Material', $this->data['Articulo']['id']); //$this->Form->fields['Articulo.id'] ?>
</div>

<div id="tabs-3" class="tab-pane">
	<label class="label">Ficha Tecnica y/u otros Documentos e Informacion referente al Material <i>( pdf, txt, xml, zip )</i></label>
	<?php echo $this->Upload->edit('doc/Material', $this->data['Articulo']['id']); //$this->Form->fields['Articulo.id'] ?>
</div> <!-- div tabs-2 -->
 
<div id="tabs-4" class="tab-pane">
	<label class="label">Cualquier otro tipo de Archivos o Documentos adicionales <i>( jpg, png, pdf, txt, xml, zip )</i></label>
	<?php echo $this->Upload->edit('etc/Material', $this->data['Articulo']['id']); //$this->Form->fields['Articulo.id'] ?>
</div>
