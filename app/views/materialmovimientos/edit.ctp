...
<div id="divFormToolBar" class="toolbar well well-small round-corners ax-toolbar">
	<div class="btn-group">	
		...
		<button type="submit" class="btn btn-primary" data-ng-click="cancel()" data-ng-disabled="!(master.Entxsal.id>0) || master.Entsal.esst=='1'" alt="Cancelar">
...
<pane id="tabs-1" heading="Detalle">
		...
		<table class="table table-condensed table-bordered table-hover">
			...
			<tr data-ng-repeat="item in details" id="row_{{item.Entsaldet.id}}" class="item-row">
				...
				<td class="span1">
					<input type="text" class="cant" data-ng-model="item.Entsaldet.esdcant"
						ui-event="{ blur : 'updateCantidad(item.Entsaldet.id,item.Entsaldet.esdcant)' }"
