...
<div class="row">
	...
	<div class="control-group">
		...
		<div class="btn-group">
			<button type="button" id="EntsalStA" class="btn btn-success" name="data[Entsal][st]" data-ng-model="master.Entsal.st" data-btn-radio="'A'">Activo</button>
			<button type="button" id="EntsalStC" class="btn btn-danger" name="data[Entsal][st]" data-ng-model="master.Entsal.st" data-btn-radio="'C'">Cancelado</button>
		</div>
		</div>
	</div>
...
myAxApp.controller('AxAppCtrl', function( $scope, $element, $http, $dialog ) {
