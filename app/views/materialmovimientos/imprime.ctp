<div id="divLayout" style="width: 8in; height: 5in; border:0px none; font-size: 9pt; margin: 0px; padding: 0px;">
	...
	<section>
	<div id="divBody" style="width: 100%; text-align: left; min-height: 2in;">
	...
	<footer>
	<div id="divFooter" style="width: 100%; height: 1in; max-height: 1in; border:1px solid #000;">
		<div id="divObservaciones" style="font-size: 8pt; height:0.4in; font-weight: bold; width: 100%; text-align: left;">
			<span style="font-weight: bold;">OBSERVACIONES:</span><br/>
			<?php echo $data['Master']['esobser']?>
		</div>
		<div id="divAuth" style="font-size: 8pt; border-top: 1px solid #000; height:0.4in; font-weight: bold; width: 100%; text-align: left;">
			<div style="width: 33%; float: left; text-align: center;">
				<span style="font-weight: bold; text-align: left; text-decoration: overline; vertical-align: -0.4in;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Autorizó&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
			</div>
			<div style="width: 33%; float: right; text-align: center;">
				<span style="font-weight: bold; text-align: center; text-decoration: overline; vertical-align: -0.4in;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Recibió&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
			</div>
			<div style="width: 33%; float: right; text-align: center;">
				<span style="font-weight: bold; text-decoration: overline; vertical-align: -0.4in;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Entregó&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
			</div>
		</div>
	</div> <!-- divFooter -->
	</footer>
...
<!--SEGUNDA NOTA-->	
		...
		<div id="divLayout" style="width: 8in; height: 5.3in; border:0px none; font-size: 9pt; margin: 0px; padding-top: 0.3in;">
