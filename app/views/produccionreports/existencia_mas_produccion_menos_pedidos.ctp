...
<h1>Existencias Mas Produccion Menos Pedidos</h1>
...
<?php $item=$item[0]; ?>
<tr>
	<td class="left"><?php echo $item['cveart'];?></td>
	<?php $itemTotals['total']=0; ?>	
	<?php for($i=0; $i<10; $i++): ?>
	<td class="right"><?php echo (int)$item['et'.$i];?></td>	
	<?php $itemTotals['total']+=$item['et'.$i]; ?>	
	<?php endfor;?>
	<td class="right"><?php echo $itemTotals['total'];?></td>		
</tr>
