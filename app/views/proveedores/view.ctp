...
<dl>
	...
	<dd class="altrow"><?php echo $proveedor['Proveedor']['prcvepro']; ?>&nbsp;</dd>
	<dt><?php __("id"); ?></dt>
	<dd><?php echo $proveedor['Proveedor']['id']; ?>&nbsp;</dd>
	<dt class="altrow"><?php __("prnom"); ?></dt>
	<dd class="altrow"><?php echo $proveedor['Proveedor']['prnom']; ?>&nbsp;</dd>
	<dt><?php __("created"); ?></dt>
	<dd><?php echo $proveedor['Proveedor']['created']; ?>&nbsp;</dd>
	<dt class="altrow"><?php __("prst"); ?></dt>
	<dd class="altrow"><?php echo $proveedor['Proveedor']['prst']; ?>&nbsp;</dd>
	<dt><?php __("modified"); ?></dt>
	<dd><?php echo $proveedor['Proveedor']['modified']; ?>&nbsp;</dd>
...
<div class="additional actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('edit_proveedor', true), array('controller' => 'proveedors', 'idd' => false, 'action' => 'edit', $proveedor['Proveedor']['id'])); ?></li>
		<li>&nbsp;</li>
