...
?>
	<table id="datagrid" class="table table-bordered table-striped table-condensed table-hover">
		...
		foreach ($transportes as $transporte):
			$class = null;
			$thisID=trim($transporte['Proveedor']['id']);
		?>
			<tr id="<?php echo $thisID?>" class="t-row">
				<td class="cvepro"><?php echo $transporte['Proveedor']['prcvepro']; ?></td>
				<td class=""><?php echo $transporte['Proveedor']['prnom']; ?></td>
				<td class="atn"><?php echo $transporte['Proveedor']['pratn']; ?></td>
				<td class="esedo"><?php echo $transporte['Estado']['esedo']; ?></td>
				<td class="st"><?php echo $transporte['Proveedor']['prst']; ?></td>
				<td class="id"><?php echo $transporte['Proveedor']['id']; ?></td>
			</tr>
		<?php endforeach; ?>
		</tbody>
	</table>
