...
*/
		/* IDD::Code When PDF extension is requested */
/*
		if ($this->requestedWith('pdf')) {
				$controller->layout = 'pdf';
		}
*/
		/* IDD::Code When txt extension is requested */
/*
		if ($this->requestedWith('txt')) {
				$controller->layout = 'text';
		}
*/
		/* IDD::Code When txt extension is requested */
/*
		if ($this->requestedWith('csv')) {
				$controller->layout = 'csv';
		}
*/
